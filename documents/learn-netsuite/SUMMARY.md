...
* [Sales Orders](netsuite-integration/flows/sales-order/README.md)
  ...
  * [Gift Card Orders](netsuite-integration/flows/sales-order/giftcard-orders.md)
  * [POS Orders](netsuite-integration/flows/sales-order/pos-orders.md)
  * [Send Sale Orders](netsuite-integration/flows/sales-order/sendsale-orders.md)
  * [Reports](netsuite-integration/flows/sales-order/reports.md)
* [Returns](netsuite-integration/flows/returns/README.md)
* [Exchanges](netsuite-integration/flows/exchanges/README.md)
* [Kit Products](netsuite-integration/flows/kit-Products.md)
* [Transfer Orders](netsuite-integration/flows/transfer-order/README.md)
  * [Warehouse to Store](netsuite-integration/flows/transfer-order/warehouse-to-store.md)
  * [Store to Warehouse](netsuite-integration/flows/transfer-order/store-to-warehouse.md)
  * [Store to Store](netsuite-integration/flows/transfer-order/store-to-store.md)
...
* [Orders](netsuite-deployment/flows/order-sync/README.md)
  ...
  * [Sync Order IDs](netsuite-deployment/flows/order-sync/sync-orderIds.md)
  * [Approve Orders](netsuite-deployment/flows/order-sync/approve-orders.md)
  * [Reports](netsuite-deployment/flows/order-sync/reports.md)
* [Allocation & Fulfillment](netsuite-deployment/flows/allocation\&fulfillmentSync/README.md)
* [Transfer Orders](netsuite-deployment/flows/transfer-order-sync/README.md)
* [Purchase Orders](netsuite-deployment/flows/purchase-order-sync/README.md)
